...
namespace Framework.Annotations
{
    ...
    ///             The method itself should be marked by <see cref="T:Framework.Annotations.AssertionMethodAttribute"/> attribute.
    ///             The mandatory argument of the attribute is the assertion type.
    /// 
    /// </summary>
    /// <seealso cref="T:Framework.Annotations.AssertionConditionType"/>
    ...
    ///             To set the condition, mark one of the parameters with <see cref="T:Framework.Annotations.AssertionConditionAttribute"/> attribute
    /// 
    /// </summary>
    /// <seealso cref="T:Framework.Annotations.AssertionConditionAttribute"/>
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false, Inherited = true)]
