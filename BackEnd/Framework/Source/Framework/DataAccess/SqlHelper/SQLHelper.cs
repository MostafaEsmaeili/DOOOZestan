...
namespace Framework.DataAccess.SqlHelper
{
    /// <summary>
    ...
    public sealed class SqlHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                if (!string.IsNullOrEmpty( SqlHelperParameterCache.ConnectionString))
                {
                    return SqlHelperParameterCache.ConnectionString;
                }
            ...
            set
            {
                ...
                SqlHelperParameterCache.ConnectionString = ConnectionString;
                SqlHelperParameterCache.ConnectionString = value;
                CustomCache.Remove("ConnectionString");
                CustomCache.Insert("ConnectionString", value);
            }
        }
        ...
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(CommandType commandType, string commandText, params object[] parameterValues)
        {
            if (string.IsNullOrEmpty(connectionString))
                throw new ArgumentNullException("connectionString");
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                foreach (object Obj in parameterValues)
                {
                    ...
                    SqlParam.ParameterName = Obj.ToString();
        ...
        {
            if (connectionString == null) throw new ArgumentNullException("connection");
            if (string.IsNullOrEmpty(spName)) throw new ArgumentNullException("spName");
        ...
        /// </summary>
        /// <param name="_connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="spName">The name of the stored procedure</param>
        /// <param name="dataRow">The dataRow used to hold the stored procedure's parameter values.</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQueryTypedParams(String _connectionString, String spName, DataRow dataRow)
        {
        ...
        /// <param name="dataRow">The dataRow used to hold the stored procedure's parameter values.</param>
        /// <returns>A dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDatasetTypedParams(string connection, String spName, DataRow dataRow)
        {
        ...
        /// <param name="dataRow">The dataRow used to hold the stored procedure's parameter values.</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        public static SqlDataReader ExecuteReaderTypedParams(String connection, String spName, DataRow dataRow)
        {
            if (connection == null || connection.Length == 0)
                throw new ArgumentNullException("connectionString");
            if (string.IsNullOrEmpty(spName)) throw new ArgumentNullException("spName");
        ...
        /// <param name="dataRow">The dataRow used to hold the stored procedure's parameter values.</param>
        /// <returns>An object containing the value in the 1x1 resultset generated by the command</returns>
        public static object ExecuteScalarTypedParams(String connection, String spName, DataRow dataRow)
        {
            if (connection == null || connection.Length == 0)
                throw new ArgumentNullException("connectionString");
            if (string.IsNullOrEmpty(spName)) throw new ArgumentNullException("spName");
